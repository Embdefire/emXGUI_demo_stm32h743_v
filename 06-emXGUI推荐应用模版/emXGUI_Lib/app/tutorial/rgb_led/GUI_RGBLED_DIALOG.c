   ...
   RECT rc;
	switch (msg)
	{
      case WM_CREATE: 
      {
         ...
         SetWindowFont(GetDlgItem(hwnd, ID_TEXTBOX_APP), logoFont252);
         ...
         SetWindowFont(GetDlgItem(hwnd, ID_TEXTBOX_R_LED), ctrlFont72);
         ...
         SetWindowFont(GetDlgItem(hwnd, ID_TEXTBOX_G_LED), ctrlFont72);
         ...
         SetWindowFont(GetDlgItem(hwnd, ID_TEXTBOX_B_LED), ctrlFont72);         
         ...
         SetWindowFont(GetDlgItem(hwnd, ID_TEXTBOX_R), ctrlFont32);                        
         //R的分量值 
         ...
         SetWindowFont(GetDlgItem(hwnd, ID_TEXTBOX_R_NUM), ctrlFont32);               
         //G的分量值 
         ...
         SetWindowFont(GetDlgItem(hwnd, ID_TEXTBOX_G_NUM), ctrlFont32);                         
         //创建文本框--蓝灯         
         ...
         SendMessage(GetDlgItem(hwnd, ID_TEXTBOX_G),TBM_SET_TEXTFLAG,0,
                        DT_SINGLELINE|DT_CENTER|DT_VCENTER|DT_BKGND);   
         SetWindowFont(GetDlgItem(hwnd, ID_TEXTBOX_G), ctrlFont32);  
         //创建文本框--绿灯
         ...
         SetWindowFont(GetDlgItem(hwnd, ID_TEXTBOX_B), ctrlFont32);
         //B的分量值         
         ...
         SetWindowFont(GetDlgItem(hwnd, ID_TEXTBOX_B_NUM), ctrlFont32);   
