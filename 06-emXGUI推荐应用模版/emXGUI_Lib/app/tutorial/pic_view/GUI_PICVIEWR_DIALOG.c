...
//图标管理数组
ICON_Typedef GUI_PicViewer_Icon[12] = 
{
...
static	LRESULT DlgINTFLASH_proc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
  switch(msg)
  {
    case WM_CREATE:
    {
      ...
      SetWindowFont(GetDlgItem(hwnd,eID_Pic_PREV),ctrlFont64); 
      ...
      SetWindowFont(GetDlgItem(hwnd,eID_ZOOMIN), ctrlFont48);  
      CreateWindow(BUTTON, L")", BS_FLAT | BS_NOTIFY | WS_TRANSPARENT|WS_OWNERDRAW| WS_VISIBLE,
                   740, 420, 60, 60, hwnd, eID_ZOOMOUT, NULL, NULL);
      SetWindowFont(GetDlgItem(hwnd,eID_ZOOMOUT), ctrlFont48);               
