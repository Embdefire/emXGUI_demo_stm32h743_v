...
//				RECT rc = {0,0,s_PicViewer_Dialog.ms_gif.img_info.Width , s_PicViewer_Dialog.ms_gif.img_info.Height};
//        SetBrushColor(gif_hdc_tmp, MapRGB(gif_hdc_tmp,PICVIWER_BACK_GROUND));
//        FillRect(gif_hdc_tmp, &rc);     
